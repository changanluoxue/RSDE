...
for n in range(1, N+1):
    ...
    '利用签名线性组合重构路径'
    paths_v_hat_all[f'order{n}'] = sig_hatW @ TA_l[:elements_number[n-1]] # np.array(M, J+1)
    paths_I_hat_all[f'order{n}'] = simulate_I(paths_v_hat_all[f'order{n}'], paths_dW, J, M) # np.array(M, J+1)
